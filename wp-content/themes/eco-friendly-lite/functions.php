...
define('ECO_FRIENDLY_LITE_URL', 'https://www.pinnaclethemes.net/');
define('ECO_FRIENDLY_LITE_PRO_THEME_URL', 'https://www.pinnaclethemes.net/product/eco-friendly-wordpress-theme/');
define('ECO_FRIENDLY_LITE_FREE_THEME_URL', 'https://www.pinnaclethemes.net/product/free-green-wordpress-theme/');
define('ECO_FRIENDLY_LITE_THEME_DOC', 'https://pinnaclethemes.net/themedocumentation/ecofriendly-documentation/');
define('ECO_FRIENDLY_LITE_LIVE_DEMO', 'https://www.pinnaclethemes.net/themedemos/ecofriendly/');
define('ECO_FRIENDLY_LITE_THEMES', 'https://www.pinnaclethemes.net/cool-wordpress-themes/');
/**
